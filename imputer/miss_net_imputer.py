...
import os
import collections
from imputer import utils

def miss_net_impute(incomp_data, alpha=0.5, beta=0.1, L=10, n_cl=1, max_iteration=20, tol=5, random_init=False, tr_ratio=0.9, logs=True, verbose=True):
    """
...
class MissNet:
    ...
    def fit(self, X, random_init=False, max_iter=20, min_iter=3, tol=5, verbose=True, savedir='./wrapper/AlgoPython/MissNet/temp'):
        """ EM algorithm """
